...
> [ToML](https://en.wikipedia.org/wiki/TOML) etc. This makes it
> possible to derive generic pretty-printers, equality functions, and
...
Pidgin is derived from the `Yocaml.Data` module (from the
[YOCaml](https://yocaml.github.io) project) and the Rensai validation
model, which originated from [Kohai](https://github.com/xvw/kohai).

The name "_Pidgin_", _a grammatically simplified form of contact
language that develops between two or more groups of people that do
not have a language in common_
([Wikipedia](https://en.wikipedia.org/wiki/Pidgin)), was suggested by
[Lorie Den
Os](https://lathan-l.github.io/tahanea/).
